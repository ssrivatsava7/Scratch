...
class YouTubeMediaController extends GetxController {
  ...
  // Add background audio handler
  final BackgroundAudioHandler _audioHandler = BackgroundAudioHandler();
  ...
  // ✅ New method for playing audio using media_kit
